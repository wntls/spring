    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <!-- search form -->
          <form action="${pageContext.request.contextPath}/sboard/listPage" method="get" class="sidebar-form">
            <div class="input-group">
              <input type="text" name="keyword" class="form-control" placeholder="Search..."/>
              <input type="hidden" name="searchType" class="form-control" value="tcw" placeholder="Search..."/>
