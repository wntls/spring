...
<div class="container">
	<form action="notice_write_submit.nb" method="post">
		...
		<div class="row m-5">
			<div class="col-md-4">
				<a href="update?notice_num=${notice.notice_num}" class="form-control btn btn-warning">수정</a>
			</div>
			<div class="col-md-4">
				<a href="#" onclick="deleteNotice('${notice.notice_num}',event);" class="form-control btn btn-danger">삭제</a>
			</div>
			<div class="col-md-4">
				<a href="list" class="form-control btn btn-primary">목록</a>
			</div>
		</div>
	</form>
</div>
<script>
	function deleteNotice(notice_num,event){
		...
		if(confirm(notice_num+" 게시물을 삭제하시겠습니까?")){
			location.href='delete?notice_num='+notice_num;
		}
	}
</script>
